...
get_playlist_items = spotipy.Spotify(auth_manager=SpotifyOAuth(client_id=spotify_client_id,
                                                               ...
                                                               # Scopes required for obtaining current user's playlist items can be found here: https://developer.spotify.com/documentation/web-api/reference/get-a-list-of-current-users-playlists
